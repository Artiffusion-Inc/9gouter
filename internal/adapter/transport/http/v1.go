...
func RegisterV1(mux *http.ServeMux, deps V1Deps) {
	...
	// GET /v1/responses/{id} — OpenAI Responses API RetrieveResponse. Returns
	// 404 (store=false → no response stored). The route surface is complete so
	// clients that poll get a clean response_not_found instead of a missing-route 404.
