...
export default function ProviderDetailPage() {
  ...
  // Fetch provider model list from its /models endpoint and add to available models.
  // Generic (Artiffusion patch): supports any provider, strips that provider's own prefix.
  const handleImportQoderModels = async () => {
    ...
    try {
      ...
      for (const model of models) {
        ...
        // Strip this provider's own prefix if present (e.g. "qoder/auto" → "auto").
        // Generic (Artiffusion patch): works for any provider, not only qoder.
